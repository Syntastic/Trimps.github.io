...
function tooltip(
    ...
    if (isItIn == 'advMaps') {
        var advTips = {
            Loot:
                'This slider allows you to fine tune the map Loot modifier. Moving this slider from left to right will guarantee more loot from the map, but increase the cost.',
            Size:
                'This slider allows you to fine tune the map Size modifier. Moving this slider from left to right will guarantee a smaller map, but increase the cost.',
            Difficulty:
            ...
            Biome:
                "If you're looking to farm something specific, you can select the biome here. Anything other than random will increase the cost of the map.",
            get Special_Modifier() {
                ...
                for (var item in mapSpecialModifierConfig) {
                    ...
                    if (getHighestLevelCleared() + 1 < unlocksAt) {
                        text +=
                            '<li><b>Next modifier unlocks at Z' +
                            unlocksAt +
                            '</b></li>';
                        break;
                    }
            ...
            Map_Preset:
                'You can save up to 3 different map configurations to switch between at will. The most recently selected setting will load each time you enter your map chamber.',
        };
    ...
    if (what == 'Trimps Info') {
        ...
        if (kongMode)
            ...
            text +=
                ' If you need to contact the developer for any reason, <a href="https://www.reddit.com/message/compose/?to=Brownprobe" target="_blank">click here to send a message on Reddit</a> or find Greensatellite in the Trimps Discord.<hr/><br/>' +
    ...
    if (what == 'Fluffy') {
        if (event == 'update') {
            ...
            tooltipText =
                "<div id='fluffyTooltipTopContainer'>" +
                fluffyTip[0] +
                '</div>';
            tooltipText +=
    ...
    if (what == 'Configure AutoStructure') {
        ...
        options =
            "<option value='0'>Apply Percent to All</option><option value='0.1'>0.1%</option><option value='1'>1%</option><option value='5'>5%</option><option value='10'>10%</option><option value='25'>25%</option>";
    ...
    if (what == 'Configure AutoJobs') {
        ...
        if (
            game.global.universe == 2 &&
            game.global.highestRadonLevelCleared > 29
        )
    ...
    if (what == 'AutoGold') {
        ...
        if (getTotalPortals() == 0)
            ...
            tooltipText +=
                ':<br/><b>' +
                voidHeName +
                '</b> - Will entrust your Scientists with purchasing as many Golden Voids as possible before switching to Golden ' +
                heName +
                ', or...<br/><b>Voidtle</b> - Where your Scientists will again attempt to buy as many Golden Voids as possible, but instead switch to Golden Battle afterwards.</p>';
        tooltipText +=
    ...
    if (what == 'Perk Preset') {
        if (textString == 'Save') {
            ...
            if (isObjectEmpty(preset)) {
                ...
                tooltipText =
                    "<p style='font-weight: bold'>This Preset holds:</p>";
                var count = 0;
    ...
    if (what == 'Portal') {
        tooltipText =
            'The portal device you found shines green in the lab. Such a familiar shade...';
        costText = '';
    }
    if (what == 'Repeat Map') {
        tooltipText =
    ...
    if (what == 'Challenge2') {
        var sup =
            portalUniverse == 1 || game.global.highestRadonLevelCleared < 64
                ? '2'
                : '3';
        ...
        if (portalUniverse == 2 && game.global.highestRadonLevelCleared < 64) {
            tooltipText =
                "<p><b style='color: #003b99'>Reach Zone 65 in Universe 2 to unlock Challenge<sup>3</sup>, which combine multiplicatively with your Challenge<sup>2</sup>. Just imagine the possibilities!</b></p>";
        } else {
            if (!textString)
                tooltipText =
            ...
            tooltipText +=
                ...
                (sup == 2
                    ? 'the attack and health bonus will increase by an additional ' +
                      ...
                      '%'
                    : 'this bonus will increase by an additional ' +
                      rewardGrowth +
                      '%') +
    ...
    if (what == 'Geneticistassist Settings') {
        if (isItIn == null) {
            ...
            tooltipText =
                "<div id='GATargetError'></div><div>Customize the target thresholds for your Geneticistassist! Use a number between 0.5 and 60 seconds for all 3 boxes. Each box corresponds to a Geneticistassist toggle threshold.</div><div style='width: 100%'><input class='GACustomInput' id='target1' value='" +
                steps[1] +
            ...
            costText =
                "<div class='maxCenter'><div class='btn btn-info' id='confirmTooltipBtn' onclick='customizeGATargets();'>Confirm</div> <div class='btn btn-danger' onclick='cancelTooltip()'>Cancel</div>";
            elem.style.left = '33.75%';
            elem.style.top = '25%';
        }
    }
    ...
    if (what == 'Set Map At Zone') {
        ...
        for (var x = 0; x < 5; x++) {
            ...
            var presetDropdown =
                ...
                ">Preset 1</option><option value='1'" +
                (vals.preset == 1 ? " selected='selected'" : '') +
                ">Preset 2</option><option value='2'" +
                (vals.preset == 2 ? " selected='selected'" : '') +
                ">Preset 3</option><option value='3'" +
            ...
            var repeatDropdown =
                ...
                ">Repeat On</option><option value='2'" +
            ...
            tooltipText +=
                ...
                '</select></div>';
            tooltipText +=
                "<div class='mazBwWorld'><div style='text-align: center;'>Exit After L</div><input value='" +
                vals.bwWorld +
        ...
        tooltipText +=
            ...
            (current.length < 5 ? 'inline-block' : 'none') +
            "' class='btn btn-success btn-md' onclick='game.options.menu.mapAtZone.addRow()'>+ Add Row</div>";
        costText =
            "<div class='maxCenter'><span class='btn btn-success btn-md' id='confirmTooltipBtn' onclick='game.options.menu.mapAtZone.save()'>Confirm</span><span class='btn btn-danger btn-md' onclick='cancelTooltip(true)'>Cancel</span>";
        game.global.lockTooltip = true;
        elem.style.top = '25%';
        elem.style.left = '25%';
        swapClass('tooltipExtra', 'tooltipExtraLg', elem);
    ...
    if (what == 'Change Heirloom Icon') {
        ...
        elem.style.top = '25%';
        costText =
            "<div class='maxCenter'><span class='btn btn-success btn-md' id='confirmTooltipBtn' onclick='cancelTooltip(true)'>Close</span>";
    }
    if (what == 'Message Config') {
        ...
        for (var x = 0; x < toCheck.length; x++) {
            ...
            for (var item in msgs[name]) {
                if (item == 'essence' && game.global.highestLevelCleared < 179)
                    continue;
                if (item == 'magma' && game.global.highestLevelCleared < 229)
                    continue;
                if (item == 'cache' && game.global.highestLevelCleared < 59)
                    continue;
                if (item == 'token' && game.global.highestLevelCleared < 235)
                    continue;
        ...
        swapClass('tooltipExtra', 'tooltipExtraLg', elem);
        costText =
            "<div class='maxCenter'><div class='btn btn-info' id='confirmTooltipBtn' onclick='cancelTooltip();configMessages();'>Confirm</div> <div class='btn btn-danger' onclick='cancelTooltip()'>Cancel</div>";
    }
    if (isItIn == 'goldenUpgrades') {
        ...
        if (what == 'Helium' && game.global.runningChallengeSquared)
            tooltipText +=
                "<br/><br/><b class='red'>You can't earn helium while running a Challenge<sup>2</sup>!</b>";
        costText = 'Free';
        ...
        if (ctrlPressed) {
            ...
            if (talent.purchased)
                ...
                if (typeof talent.requires !== 'undefined') {
                    ...
                    if (needed.length)
                        requiresText = formatListCommasAndStuff(needed);
                }
                if (
                    ...
                    var lastTierTalents = countPurchasedTalents(
                        talent.tier - 1,
                    );
                    ...
                    if (requiresText)
                        costText +=
                            '. This Mastery also requires ' + requiresText;
                    costText += ')</span>';
                } else if (requiresText)
                    costText =
                        "<span style='color: red'>Requires " +
                        requiresText +
                        '</span>';
                else if (
    ...
    if (what == 'Mastery') {
        tooltipText =
            '<p>Click to view your masteries.</p><p>You currently have ' +
    ...
    if (what == 'MagnetoShriek') {
        ...
        tooltipText =
            'Your pet RoboTrimp seems to be gifted at distorting the magnetic field around certain Bad Guys, especially Improbabilities. You can activate this ability once every 5 Zones in order to tell your RoboTrimp to reduce the attack damage of the next Improbability by ' +
            shriekValue +
        ...
        tooltipText += game.global.useShriek
            ? 'MagnetoShriek is currently active and will fire on the next Improbability.'
    ...
    if (what == 'Reset') {
        ...
        costText =
            "<div class='maxCenter'><div class='btn btn-danger' onclick='resetGame();unlockTooltip();tooltip(\"hide\")'>Delete Save</div> <div class='btn btn-info' onclick='cancelTooltip()'>Cancel</div></div>";
        game.global.lockTooltip = true;
        elem.style.left = '33.75%';
        elem.style.top = '25%';
    }
    ...
    if (what == 'AutoFight') {
        tooltipText =
            'Allow the Trimps to start fighting on their own whenever their town gets overcrowded (Hotkey: A)';
        costText = '';
    }
    ...
    if (isItIn == 'jobs') {
        ...
        if (game.global.firing && what != 'Amalgamator') {
            ...
            var ignoreWorkspaces =
                ...
                game.options.menu.fireForJobs.enabled;
    ...
    if (what == 'Scale Equality Scaling') {
        tooltipText =
            "Change this Slider to change the maximum amount of attacks Trimps need to make in order to not trigger Equality Scaling. Setting this slider to 0 will increase scaling whenever a group of Trimps is one-shot, 1 will increase if Trimps attack one or fewer times, 5 will only increase if they attack 5 or fewer times, etc.<br/><br/><b>Your current setting is <span id='equalityCurrentScale'>" +
            game.portal.Equality.scalingSetting +
            '</span></b>';
        tooltipText +=
            "<br/><br/><input oninput='scaleEqualityScale(this)' onchange='scaleEqualityScale(this)' type='range' id='scaleEqualitySlider' min='0' max='10' value='" +
            game.portal.Equality.scalingSetting +
            "' />";
        game.global.lockTooltip = true;
        elem.style.left = '33.75%';
    ...
    if (what == 'Equality Scaling') {
        ...
        tooltipText =
            '<p>You can enable or disable Equality Scaling at any time.</p><p>With Equality Scaling On, each Portal starts with 0 levels of Equality active. If a group of Trimps dies after attacking less than <b>' +
            game.portal.Equality.scalingSetting +
            '</b> time' +
            needAnS(game.portal.Equality.scalingSetting) +
            ', one level of Equality will activate, up to your purchased level of Equality.';
        tooltipText +=
            ' <b>Your Trimps have died below the attacks threshold ' +
            fightsLost +
            ' time' +
            needAnS(fightsLost) +
            ' this run';
        ...
        tooltipText +=
            '</b></p><p>With Equality Scaling Off, the full amount of purchased levels of Equality are always active.</p>';
        tooltipText +=
            '<p><b>Ctrl Click this button to manually change the maximum attack threshold for scaling.</b></p>';
        ...
        tooltipText +=
            ' <b>(You have spent ' +
            prettify(
                getSpentPerkResource(what, true) + perkItem.heliumSpentTemp,
            ) +
            ' ' +
    ...
    if (isItIn == 'equipment') {
        ...
        if (what == 'Shield' && game.equipment.Shield.blockNow) {
            var blockPerShield =
                game.equipment.Shield.blockCalculated +
                game.equipment.Shield.blockCalculated *
    ...
    if (isItIn == 'upgrades') {
        ...
        if (typeof tooltipText.split('@')[1] !== 'undefined') {
            var prestigeCost =
                '<b>You may not want to do this right away.</b> Your next ' +
        ...
        if (what == 'Coordination') {
            ...
            if (!canAffordCoordinationTrimps()) {
                var currentSend = game.resources.trimps.getCurrentSend();
                var amtToGo = Math.floor(
                    currentSend * 3 - game.resources.trimps.realMax(),
                );
                var s = amtToGo == 1 ? '' : 's';
                tooltipText +=
                    ' <b>You need enough room for ' +
                    prettify(currentSend * 3) +
                    ' max Trimps. You are short ' +
        ...
        if (typeof tipSplit[1] !== 'undefined') {
            if (tipSplit[1] == 'incby') {
                ...
                if (getPerkLevel('Motivation_II') > 0)
                    newValue *=
                        1 +
                        getPerkLevel('Motivation_II') *
                            game.portal.Motivation_II.modifier;
                if (Fluffy.isRewardActive('gatherer')) newValue *= 2;
                tooltipText = tipSplit[0] + prettify(newValue) + tipSplit[2];
            } else
                tooltipText =
                    tipSplit[0] + prettify(toTip[tipSplit[1]]) + tipSplit[2];
        }
        if (
            isItIn == 'buildings' &&
...
function updateMazPreset(index) {
    var preset = parseInt(
        document.getElementById('mazPreset' + index).value,
        10,
    );
...
function buildNiceCheckbox(id, extraClass, enabled) {
    ...
    html =
        ...
        "' " +
        html +
        " onclick='swapNiceCheckbox(this)'></span>";
    return html;
}
            ...
            for (var item in costItem) {
                ...
                if (
                    ...
                    if (
                        ...
                        typeof game.global.dailyChallenge.metallicThumb !==
                            'undefined'
                    ) {
                        price *= dailyModifiers.metallicThumb.getMult(
                ...
                if (typeof price[1] !== 'undefined')
                    price = resolvePow(price, toTip);
                var itemToCheck = game[cost];
                if (typeof itemToCheck[item] !== 'undefined') {
                    canAfford =
                        itemToCheck[item].owned >= price ? 'green' : 'red';
                    if (
...
function messageConfigHover(what, event) {
    ...
    switch (what) {
        ...
        case 'Lootevents':
            text =
                'Log drops and messages from temporary events, such as holidays.';
            title = 'Events';
            break;
        case 'Lootexotic':
...
function getZoneStats(event, update) {
    ...
    textString +=
        ...
        formatMinutesForDescriptions(getZoneMinutes()) +
        '</td></tr>';
    ...
    if (
        ...
        textString +=
            ...
            formatMinutesForDescriptions(
                (getGameTime() - game.global.mapStarted) / 1000 / 60,
            ) +
            '</td></tr>';
        var stackedMaps = 0;
        ...
        if (map.location == 'Void')
            textString +=
                ...
                (stackedMaps ? ' (' + stackedMaps + ' stacked).' : '') +
                '</td></tr>';
    }
...
function getBattleStatBd(what) {
    ...
    var textString =
        "<table class='bdTableSm table table-striped'><tbody><tr><td></td><td>Base</td><td>Level</td><td>Item " +
        name +
        '</td><td>Total</td>' +
    ...
    if (what == 'health' || what == 'attack') {
        ...
        if (what == 'attack') {
            //Discipline
            if (
                game.global.challengeActive == 'Discipline' ||
                ...
                //MinDamageDaily
                if (
                    typeof game.global.dailyChallenge.minDamage !== 'undefined'
                ) {
                ...
                //MaxDamageDaily
                if (
                    typeof game.global.dailyChallenge.maxDamage !== 'undefined'
                ) {
        ...
        for (var equip in game.equipment) {
            ...
            percent =
                ((equipStrength / game.global[what]) * 100).toFixed(1) + '%';
            textString +=
                "<tr><td class='bdTitle'>" +
                equip +
                '</td><td>' +
        ...
        if (gym.owned > 0) {
            ...
            percent =
                ((gymStrength / game.global.block) * 100).toFixed(1) + '%';
        ...
        if (shield.blockNow && shield.level > 0) {
            ...
            percent =
                ((shieldStrength / game.global.block) * 100).toFixed(1) + '%';
        ...
        if (getPerkLevel('Prismal') > 0) {
            var thisAmt =
                getPerkLevel('Prismal') * game.portal.Prismal.modifier;
            currentCalc += thisAmt;
            textString +=
        ...
        if (game.global.challengeActive == 'Bublé') {
            currentCalc += 1;
            textString +=
                "<tr><td class='bdTitle'>Bublé (Challenge)</td><td>100%</td><td>&nbsp;</td><td>100%</td><td>" +
                Math.round(currentCalc * 100) +
                '%</td></tr>';
        }
    ...
    if (
        ...
        textString +=
            "<tr><td class='bdTitle'>Smithy</td><td>x 1.25</td><td>" +
    ...
    if (
        ...
        mapBonusMult *= 100;
        textString +=
            "<tr><td class='bdTitle'>Map Bonus</td><td>20%</td><td>" +
    ...
    if (
        ...
        currentCalc *= 1 + amt / 100;
        var c2Name =
            game.global.highestRadonLevelCleared < 64
                ? '2'
                : "<span class='icomoon icon-infinity'></span>";
        textString +=
    ...
    if (what == 'attack') {
        ...
        if (critChance < 0) {
            ...
            if (critChance > 0) {
                ...
                if (critChance > 1)
                    textString +=
                        ' (' + (critChance * 100).toFixed(1) + '% Total)';
                textString +=
...
function formatMultAsPercent(mult) {
    if (mult < 1) return '- ' + Math.round(10000 * (1 - mult)) / 100 + '%';
...
function getLootBd(what) {
    ...
    switch (what) {
        case 'Food/Wood/Metal':
            var tempModifier =
                ...
                Math.pow(
                    1.25,
                    game.global.world >= 59 ? 59 : game.global.world,
                );
            //Mega books
        ...
        case 'Helium':
            ...
            if (game.jobs.Meteorologist.vestedHires > 0) {
                ...
                currentCalc *= amt;
                textString +=
                    "<tr><td class='bdTitle'>Meteorologists</td><td>1%</td><td>" +
    ...
    if (game.global.runningChallengeSquared && what == 'Helium') {
        currentCalc = 0;
        textString +=
            "<tr class='colorSquared'><td class='bdTitle'>Challenge²</td><td></td><td></td><td>0%</td><td>" +
            prettify(currentCalc) +
            '</td></tr>';
    }
...
function swapNotation(updateOnly) {
    if (!updateOnly)
        game.options.menu.standardNotation.enabled = !game.options.menu
...
function prettify(number) {
    ...
    if (game.options.menu.standardNotation.enabled == 3) {
        ...
        if (base <= suffices.length) suffix = suffices[base - 1];
            ...
            suffix =
                suffices[Math.ceil(base / suffices.length) - 2] +
                suffices[suf2];
        }
    } else {
        var suffices = [
...
function resetGame(keepPortal) {
    ...
    if (keepPortal) {
        ...
        if (
            game.global.universe == 1 &&
            game.stats.bestHeliumHour.valueTotal <
                game.stats.heliumHour.value(true)
        ) {
            game.stats.bestHeliumHour.valueTotal = game.stats.heliumHour.value(
                true,
            );
        } else if (
            game.global.universe == 2 &&
            game.stats.bestRadonHour.valueTotal <
                game.stats.heliumHour.value(true)
        ) {
            game.stats.bestRadonHour.valueTotal = game.stats.heliumHour.value(
                true,
            );
        }
        if (
            Fluffy.getBestExpStat().value > 0 &&
            Fluffy.getBestExpHourStat().valueTotal <
                game.stats.fluffyExpHour.value()
        ) {
        ...
        if (game.global.universe == 2) {
            if (
                ...
                game.global.lastRadonPortal >= 100 &&
        ...
        if (game.global.universe == 2) {
            if (lastRadonPortal < voidMaxLevel2) {
                ...
                if (voidMaxLevel2 < lastRadonPortal)
                    voidMaxLevel2 = lastRadonPortal;
            }
        } else {
    ...
    if (keepPortal) {
        ...
        if (challenge == 'Daily')
            game.global.dailyChallenge = getDailyChallenge(
                readingDaily,
                true,
                false,
            );
        ...
        if (
            challenge !== '' &&
            typeof game.challenges[challenge].start !== 'undefined'
        )
            game.challenges[challenge].start();
        ...
        if (game.global.totalPortals == 5)
            message(
                'Heavy use of the portal has created a chance for the Void to seep into your world. Be alert.',
                'Story',
                null,
                'voidMessage',
            );
        if (game.global.totalPortals >= 5)
            document.getElementById('heirloomBtnContainer').style.display =
                'block';
    ...
    if (oldUniverse != game.global.universe) {
        ...
        if (newSetting.Shield != -1)
            equipHeirloomById(newSetting.Shield, 'Shield');
        if (newSetting.Staff != -1)
            equipHeirloomById(newSetting.Staff, 'Staff');
    }
}
...
function filterTabs(what) {
    ...
    buyContainer.style.height =
        game.global.highestLevelCleared >= 180
            ? 'calc(99vh - 22.2vw - 175px)'
    ...
    for (var tab in tabs) {
        ...
        document.getElementById(tab + 'Container').style.display =
            (what == 'all' && tab != 'talents' && tab != 'nature') ||
            tab == what
                ? 'block'
                : 'none';
    }
...
function numTab(what, p) {
    ...
    if (what == 5) {
        ...
        if (!isNumberBad(num)) {
            ...
            if (game.global.firstCustomAmt == -1)
                game.global.firstCustomAmt = num;
        } else {
...
function updateLabels() {
    ...
    for (var item in game.resources) {
        ...
        if (
            toUpdate.max == -1 ||
            document.getElementById(item + 'Max') === null
        )
            continue;
        ...
        if (item != 'trimps')
            newMax = calcHeirloomBonus(
                ...
                'storageSize',
                newMax *
                    (game.portal.Packrat.modifier * getPerkLevel('Packrat') +
                        1),
            );
        ...
        if (game.options.menu.progressBars.enabled) {
            ...
            swapClass(
                'percentColor',
                getBarColorClass(100 - percentToMax),
                bar,
            );
...
function updateSideTrimps() {
    ...
    var breedCount =
        trimps.owned - trimps.employed > 2
            ? prettify(Math.floor(trimps.owned - trimps.employed))
            : 0;
...
function getUniqueColor(item) {
    ...
    if (item.location && game.mapConfig.locations[item.location].upgrade) {
        ...
        if (upgrade.specialFilter) {
            ...
            if (
                upgrade.specialFilter(item.level) &&
                typeof upgrade.canRunOnce === 'undefined'
            )
                return ' noRecycle';
        }
...
function unlockMap(what) {
    ...
    if (item.location == 'Void') {
        ...
        tooltip =
            " onmouseover=\"tooltip('Void Map', 'customText', event, 'This Map will scale in level to your current Zone Number, enemies have a random buff, and the boss at the final cell will drop helium. This map will disappear after it is completed once, and leaving the map will reset its progress.');\" onmouseout=\"tooltip('hide')\"";
        loc = 'voidMapsHere';
    }
    ...
    if (item.location == 'Bionic' && game.talents.bionic2.purchased)
    ...
    if (what == 'upgrades') {
        for (var itemA in game.upgrades) {
            ...
            if (itemA == 'Coordination')
                updateButtonColor(
                    itemA,
                    canAffordTwoLevel(game.upgrades[itemA]) &&
 ...
 */ updateButtonColor(
    ...
    for (var itemB in where) {
        ...
        for (var cost in where[itemB].cost) {
            ...
            var numCost =
                typeof costItem === 'function' ? costItem() : costItem;
...
function clearNewSettings() {
    for (var item in game.options.menu) {
        if (game.options.menu[item].isNew)
            game.options.menu[item].isNew = false;
    }
    hasNewSetting = false;
    toggleSettingAlert();
...
function displayAllSettings() {
    ...
    for (var item in game.options.menu) {
        ...
        if (
            typeof optionItem.lockUnless === 'function' &&
            !optionItem.lockUnless()
        )
            continue;
...
function searchSettings(elem) {
    ...
    for (var optionName in game.options.menu) {
        ...
        if (
            optionObject.extraTags &&
            optionObject.extraTags.search(search) != -1
        )
            results.push(optionName);
...
function toggleSetting(setting, elem, fromPortal, updateOnly, backwards) {
    ...
    if (typeof menuOption.secondLocation !== 'undefined') {
        for (var z = 0; z < menuOption.secondLocation.length; z++) {
            menuElem.push(
                document.getElementById(menuOption.secondLocation[z]),
            );
        }
    }
...
function displayAchievementPopup(id, forHover, displayNumber) {
    ...
    if (index != -1) {
        document.getElementById(id + displayNumber + 'Alert').style.display =
            'none';
        achievement.newStuff.splice(index, 1);
    }
    var location = forHover ? 'Hover' : 'Popup';
    if (!forHover && typeof achievement.finished === 'number')
    ...
    if (
        ...
        ((!one &&
            ...
            displayNumber > achievement.finished) ||
            (one &&
                achievement.filterLevel() <
                    achievement.filters[displayNumber] &&
                !achievement.finished[displayNumber]))
    ) {
        document.getElementById('achievement' + location).style.display =
            'block';
        document.getElementById(
    ...
    document.getElementById(
        'achievement' + location + 'Description',
    ).innerHTML = achievement.description(displayNumber);
    document.getElementById('achievement' + location + 'Reward').innerHTML =
        '<b>Reward:</b> +' +
        game.tierValues[achievement.tiers[displayNumber]] +
        '% Damage';
...
function checkAchieve(id, evalProperty, doubleChecking, noDisplay) {
    ...
    if (typeof achievement.breakpoints[achievement.finished] === 'number') {
        if (!achievement.reverse) {
            if (evalProperty < achievement.breakpoints[achievement.finished])
                return;
        } else {
            if (evalProperty >= achievement.breakpoints[achievement.finished])
                return;
...
function displayAchievements() {
    ...
    for (var item in game.achievements) {
        ...
        var achievement = game.achievements[item];
        if (
            typeof achievement.display !== 'undefined' &&
            !achievement.display()
        )
            continue;
        ...
        if (usingScreenReader) {
            for (var x = 0; x < amount; x++) {
                ...
                if (x == 0) {
                    htmlString +=
                        "<tr><td title='achievementGroup'>" + achievement.title;
                    if (
                        hasProgress &&
                        !one &&
                ...
                if (!locked) {
                    if (hasProgress && !SRfinished) {
                        htmlString +=
                            '<br/>Progress: ' + achievement.progress();
                    }
        ...
        for (var x = 0; x < amount; x++) {
            ...
            var borderStyle = '';
            var tierValue =
                "<span style='color: black;' class='{ICONCLASS}'></span>";
            if (
                (!one && achievement.finished == x) ||
                (one &&
                    !achievement.finished[x] &&
            ...
            htmlString +=
                '<div onmouseover="displayAchievementPopup(\'' +
                item +
                "', true, " +
                x +
...
function toggleAchievementWindow() {
    ...
    document.getElementById(
        'achievementWrapper',
    ).style.display = trimpAchievementsOpen ? 'none' : 'block';
...
function checkFeatEarnable(which) {
    var failables = {
        ...
        Workplace_Safety: function() {
            return (
                game.global.world < 60 && game.stats.trimpsKilled.value <= 1000
            );
        },
...
function getWorldText(zoneNumber) {
    var universe1 = {
        w2:
            "Your Trimps killed a lot of Bad Guys back there. It seems like you're getting the hang of this. However, the world is large, and there are many more Zones to explore. Chop chop.",
        w3:
            'By your orders, your scientists have begun to try and figure out how large this planet is.',
        w4:
            'You order your Trimps to search the area for the keys to your ship, but nobody finds anything. Bummer.',
        w5:
            "Do you see that thing at the end of this Zone? It's huge! It's terrifying! You've never seen anything like it before, but you know that it is a Blimp. How did you know that? Stop knowing things and go kill it.",
        w6:
            'You step over the corpse of the Blimp as it rapidly deflates, and one of your Trimps chuckles at the sound produced. You all cross the sulfuric river to the next Zone, and can feel the presence of an ancient knowledge. Better explore.',
        w7:
            "Slow and steady wins the race. Unless you're racing someone who is actually trying.",
        w8:
        ...
        w10:
            'Looks like another Blimp up ahead. Hard to tell from far away, but it looks like it has more heads than the last one.',
        w11:
            "You're unstoppable as long as nothing stops you. Unfortunately, it seems like something really wants to stop you.",
        w12: 'Did you see that green light flash by? Weird. Oh well.',
        w13:
            "Your scientists have finally concluded their report on the analysis of the size of the world. According to the report, they're pretty sure it's infinitely large, but you're pretty sure they just got bored of checking.",
        w14:
            'You were trying to help bring back some of the Equipment your Trimps left on the ground in that last Zone, and you got a splinter. This planet is getting dangerous, stay alert.',
        w15: 'Another day, another Blimp at the end of the Zone.',
        w16: 'Seriously? Another Blimp so soon?',
        w17:
            'You climb a large cliff and look out over the new Zone. Red dirt, scorched ground, and devastation. Is that a Dragimp flying around out there?!',
        w18:
            'There seems to be a strange force urging you to keep going. The atmosphere is becoming... angrier. Part of you wants to turn around and go back, but most of you wants to keep going.',
        w19:
        ...
        w25:
            "You're a rebel. The universe pointed you into that portal, but you kept pushing forward. You feel... less like you've been here before.",
        w27:
            'It seems like the further you press on, the less you know. You still feel an urge to use the portal, though the urge has begun to dwindle.',
        w29:
            "Your Trimps came up with a pretty catchy battle song that got stuck in your head. None of them survived the next fight though, and you can't remember most of it. Life's tough.",
        w33:
            'You climb over a large hill that was separating this Zone from the last. The sky is pitch black and lightning crackles in the distance. This is a site of heavy corruption.',
        w35:
            "You start to wonder how long you've been doing the same thing over and over. There must be something you can do to start to break the cycle. Perhaps you could alter the portal...",
        w40:
            "You can't help but notice that the Trimps seem to be the only creatures on this planet not immediately hostile towards outsiders. You ask a nearby Trimp soldier what he thinks you are, and he drools a bit.",
        w42:
            "The world seems so barren out this far. You feel like you're finally starting to get ahead of the curve, but you know by now not to get comfortable.",
        w44:
            'Each day and night seems to grow longer than the one before. Is time slowing down? Argh! You fall to your knees with a splitting headache and a strong desire to use the portal. After a few minutes, it passes and you forget what happened. What are we talking about?',
        w46:
            'All traces of hills and mountains have long since been trudged past. The world is flat and hostile. You wish your Trimps were better conversationalists.',
        w48:
            "As your Trimps scavenge every last bit of helium from that Blimp, one of them begins freaking out. He runs around waving his little arms and making funny noises for a while, eats some dirt, then takes a little nap. You wonder if that's normal. Yeah... probably fine.",
        w50:
            "It's been a long time since you've found any blueprints in the maps. You start to wonder where those things even come from.",
        w51:
            "Your scientists have detected an anomaly at the end of Zone 59. They recommend that you stop doing whatever it is that you're doing.",
        w53:
            'As you get closer to the anomaly, you start to notice more and more strange behaviour from your Trimps. Holes in your memory are starting to become noticeable as multiple existences blend into one. Trippy.',
        w54:
            'As you get closer to the anomaly, you start to notice more and more strange behaviour from your Trimps. Holes in your memory are starting to become noticeable as multiple existences blend into one. Trippy.',
        w56:
            'A loud boom echoes in the distance, and one of your Trimps runs up to you with outstretched arms, looking quite frightened. He probably just wants some armor and weapons! You hand him some gear, and he accepts it with excitement.',
        w58:
            "A huge storm has formed and daylight has become a luxury you have mostly forgotten about. Your Trimps seem to want to go back home, but you're pretty sure you're supposed to keep going this way, so you do. You're very close to the anomaly.",
        w59:
            "There it is. The anomaly is at the end of the Zone. You can see it but you don't know what you're seeing. Where did that... thing... come from?! This is highly Improbable.",
        w60:
            "The ground instantly cracks and large plumes of green gas escape from the planet's core to the atmosphere. The planet feels different. Everything feels different. This Universe has grown unstable, the planet has broken. What have you done?",
        ...
        w68:
            "You figure some entertainment wouldn't be awful, and decide to teach your Trimps how to play soccer. A few hours and zero progress later, you really regret that decision.",
        w70:
            "The Improbabilities haven't seemed to slow down. You know you need to figure out a plan, but you don't know what to plan for.",
        w72:
            "You slash through another Improbability with relative ease, but something isn't right. A sour smell hits your nose and in disgust, you whip around in search of the source. Oh, wait, it's just the Trimps.",
        w80:
            "When's the last time you made a map? You have a feeling you should probably do that.",
        w82:
            "Whew, that was an exhilarating kill. You decide to reward your Trimps with some Improbability stew. It's pretty tasty.",
        w83: 'That stew was probably a bad idea. Anyone else feeling sick?',
        w85:
            "An ancient and fuzzy memory just crept back into your head. You're not quite sure where it came from, but you know the memory is yours. You remember being on a ship, and seeing this planet from orbit. There was someone with you!",
        w87:
            'Bits and pieces of memories continue trickling back in as you continue to put distance between yourself and the source of Anger. You can almost see in your mind who you came here with. Where could they be...',
        w90:
            "You decide to ask your scientists to come up with an extravagant machine that can scan your brain for old memories to see if there's anything helpful up there. They seem excited about a new project and quickly get to work.",
        w92:
            'You hear a huge explosion from the science lab and realize that the brain scan machine will probably never be finished.',
        get w95() {
            if (
                game.global.challengeActive == 'Trimp' &&
                game.jobs.Amalgamator.owned > 0
        ...
        w100:
            "You stop dead in your tracks. You remember who you came here with, and you remember that you are not happy with Captain Druopitee for bringing you here. You know he landed with you. You know the ship is still here. He's here.",
        w105:
            'You call a meeting with all of your Trimps to explain the situation. After giving an extremely long, epic, and motivational speech but hearing no reaction from the crowd, you remember that your Trimps cannot understand you. Will you ever learn?',
        w106:
            'How long have you been trapped on this planet? Months? Decades? Travelling through time sure screws up your chronological perception.',
        w109:
            "Though you have no idea which direction your home planet is, you still believe the ship's GPS could get you home. Maybe Druopitee has the keys. You really want to find him.",
        w115:
            'You just remembered what a taco was. You could really use a taco right now.',
        w120:
            "Your stamina is quickly dwindling. Trying to keep up with so many more extra Trimps each Zone is beginning to wear you down. You'll need to practice fighting with stronger, smaller groups to succeed.",
        w123:
            "Woah, you have a lot of Trimps right now. You hadn't really stopped to think about just how many individual Trimps you have directly under your control in a while. Neat!",
        w125:
            'You smell metal and gears, and suddenly feel like you should run a map.',
        w130:
        ...
        w132:
            "You can't stop thinking about where that Trimp found the coordinates for the Slow dimension. Why can't whatever is helping you just come out and help you?",
        w135:
            'Ugh, your back is getting sore. It seems like travelling back in time does not reverse the ageing process for the traveller. Bummer.',
        w136:
            "One of your scientists has informed you that his team was able to successfully create a cure for a non-existent disease. He explains that it's best to be prepared. You sigh heavily.",
        w137:
            "One of your scientists has informed you that an outbreak of a new disease was detected in the laboratory. You go to check on your scientists, and it's quite obvious that they're faking it for attention. You sigh heavily.",
        w138:
            'You spot another scientist running full speed towards you. He hurriedly informs you that they discovered a new dimension near Zone 35 that is occupied by gigantic Trimps. You sigh heavily.',
        w139:
            'Another scientist is coming. You sigh heavily. He says something dumb. You decide to ignore the scientists for a little bit.',
        w140:
            "It sure is calm and peaceful now. You watch a Falcimp turn a few circles in the sky. You wouldn't mind having wings, but overall you're pretty happy with your species.",
        w143:
            "There's a scientist jumping around trying to get your attention. There's nothing interesting in the sky so you pretend to be fascinated with a rock. The scientist can see you're busy and waits patiently.",
        w145:
            "Your Scientists are not making it easy to ignore them. You not-so-calmly ask what they want. One of them explains that they discovered a new dimension with lots of extra helium. You'll probably check it out, but you won't tell them that.",
        w150:
            "Wow. These structures are getting expensive. There's probably a dimension for that...",
        w153:
            "You remember a person from your past. From your old life. There's someone you need to get back to. You'll make it back.",
        w156:
            'You watch in amazement as a Trimp grabs on to one of those weird tree things and swings around by its arms. These things are getting pretty strong.',
        w157:
            'You watch in less amazement as a Trimp tries to take a bite out of a very large rock. These things are not getting much smarter.',
        w159:
            "That's quite a sunset. You know once you finally make it out of here, you'll definitely never forget the sights. Unless, of course, you do.",
        w160:
        ...
        w163:
            "Your scientists have informed you that half of the boot is now lost in another dimension, thanks to an 'important' test. The results were inconclusive. You ask them to please leave the remaining half in our current dimension, and they look disappointed.",
        w165:
            "What's this now?! You found a little green piece of metal. Your scientists tell you that it came from a toxic dimension, but that it is also from a dimension rich in helium. They let you know that they can tune your portal to travel to the dimension it originated from, should you want to check it out.",
        ...
        w174:
            "Strange smells continue to swell around you. Judging by changes in wind direction, the smells are coming from the spire. You still can't describe it other than purple.",
        w175:
            "Your Trimps seem happy. They're not used to having a purpose, and having one seems to positively affect them! You call a Trimp over and ask him how he's doing, then you remember that he can't talk.",
        w178:
            "You're still not quite sure what that smell is. You feel slightly more powerful, and you fear that your enemies may feel the same way.",
        get w180() {
            if (game.global.challengeActive != 'Corrupted')
        ...
        w182:
            "Well, there's not really much doubt about it anymore. Some sort of intelligence is intentionally making life more difficult for you and your Trimps. You take this as a sign that you're pretty important, why else would something risk destroying an entire planet to stop you? Your parents would be so proud.",
        get w184() {
            return (
        ...
        w185:
            "You have trouble putting into words exactly what the Corruption does to the creatures on this planet. They seem to be stripped of all natural abilities and given powers that you didn't know could exist in the primary dimension.",
        w187:
            'None of these corrupted enemies seem to have eyes, so you decide to see if you can get away with flipping one off. As it reacts by roaring and stomping around in a rage, you realize that these things are powerful enough not to need eyes to observe the world. What <i>are</i> these?!',
        w190:
        ...
        w193:
            "The corruption continues to thicken as you near the Spire. You're beginning to grow accustomed to the smell of the Spire, and really don't mind it anymore. It reminds you of blueberries. Evil blueberries.",
        w198:
        ...
        w225:
            "You wake up in a sweat after a good night's sleep in a cool, dark cave. You dreamt that you were overheating, though that's never really been a problem before. Oh well, strange dreams and memories haven't really indicated anything important before, it's probably nothing.",
        w231: "It's pretty hot.",
        w232:
            "The heat intensifies as you move further and further through the Zones. Instinct says to turn away from the heat, but that wouldn't be any fun.",
        w234: [
        ...
        w255:
            "The Magma continues to sap your Trimps' strength as you press through the Zones, but they seem to be adapting well in spirits. It seems like each generation likes the heat more and more.",
        w256: [
        ...
        w261:
            'You asked that Omnipotrimp nicely not to explode after you killed it, but it exploded anyways. Pretty rude.',
        w264: [
        ...
        w270:
            "This planet is really freaking big. You feel like you've been walking around it for years and still haven't seen everything there is to offer. Shouldn't there be another spire around here or something?",
        w277:
            "It's starting to smell purple again. You must be getting close to another spire.",
        get w283() {
        ...
        w350:
            'If Druopitee has really immortalized himself in an infinite amount of Spires, you might be here for a while.',
        get w360() {
            if (game.global.spireRows >= 15 || Fluffy.getCapableLevel() > 0)
        ...
        w375:
            "Should be coming up on another Spire Zone soon. You stop and sit beside a beautiful Magma river and wonder what kinds of crazy stuff could be waiting for you up there. Then you realize it's probably just another Spire, so you get up and keep moving.",
        w385:
            'Some familiar Spirish odors begin hitting your nostrils again and you sneeze, hilariously startling a few billion Trimps. Never gets old.',
        get w390() {
            if (game.global.lastSpireCleared == 2)
        ...
        w430:
            'The Trimps tried tying two Turkimps to this tall tree, then the Turkimps thrashed those three trillion Trimps, throwing the Trimps tumbling towards the tall tree. The Trimps truly tried. Those Turkimps though... they tough.',
        w440:
            "Wow, you've gotten pretty far. You would have never guessed there'd be this many Zones out there, but here you are.",
        w450: "It's just about time for another Spire, don't you think?",
        w460:
            "This part of the world seems to be at a much higher elevation than any other part that you've been at. The air is strangely clear, and you can see more of the planet sprawled out around you than ever before. It feels good to see everything you're fighting for and feel like it's worth it.",
        w470:
            'This part of the world seems to be at a really low elevation, and lots of Corruption is building up in it. Gross.',
        get w485() {
            if (game.global.lastSpireCleared == 3)
        ...
        w702:
            "The planet looks pretty charred. Fluffy looks proud of something but you're not sure what.",
        w707:
            "You feel like there is supposed to be something here that isn't. You wonder if you had something to do with that.",
    };
    var universe2 = {
        w2:
            '"A journey of 1000 Zones begins with a single Zone." - Probably someone',
        w3:
            "While this Universe seems very similar to the one you were just in, it feels quite a bit different. You can't quite figure out what exactly is different, but it totally is.",
        w4:
            "You feel like you've climbed through these Zones thousands of times, but you can only clearly remember one time that felt like ages ago in a different Universe. You feel weird.",
        w5:
            "But have you been to this Universe before? You're really not quite sure. Every day that passes here makes your memories feel like another lifetime ago.",
        w6:
            "You decide to tell the story of your travels to your Trimps, so that someone will remember if your memory continues to get worse. You tell them about the massive armies, the Spires, Druopitee, Nature, and everything else you can think of. The Trimps seem excited by the tale, but they can't talk.",
        w7:
            'Scruffy runs up to inform you that you could run a regular map to find directions to something called "Big Wall". You remember a wall from before, but you don\'t remember finding it so soon. What else is going to be different?',
        w8:
            "At your request, your Scientists are running tests to try and identify further differences between your original Universe and this one. Unfortunately, they don't know anything about your old Universe and probably won't be able to spot any differences.",
        w9:
            'One thing you remember for sure about the last Universe is that you found a Portal device at the twentieth zone. However here, your Scientists have detected a massive portalesque energy reading on only the fifteenth Zone. Interesting.',
        w10:
        ...
        w11:
            'Apparently a few elements have different properties here than back in the last Universe. Either that or the Trimps currently bathing in mercury are going to have a rough future.',
        w12:
            "You start to feel angry as you get closer to the fifteenth Zone. You're not sure if it's due to the energy your scientists detected, or the Trimps that keep throwing berries at your head. But one of them is definitely making you angry.",
        w13:
            "Scruffy informs you that there is one particular element regarded as king here, Radon. While highly volatile in your home Universe, it's a stable gas here with tremendous potential for power generation.",
        w14:
        ...
        w15:
            'There is a device of great evil here. See if you can take it for yourself!',
        w20:
            "Holy cowimp, there's an Improbability at the end of this Zone! But the planet doesn't look broken, this is... improbable...",
        w22:
            'Your Scientists have confirmed that the Spires are indeed still active on this planet, but are incredibly far away in lands your Trimps are nowhere near powerful enough to survive in.',
        w24:
            "Knowing that Druopitee is in your Universe, you ask Scruffy who is manning the Spires. He hangs his head in shame and lets you know that there are 5 Trimps, previously friends of Scruffy's, that were enticed by Druopitee's magic. He doesn't seem to want to talk much more about it.",
        w26:
            'Your Trimps catch a bird and build a little home for it, but it flies away.',
        w28:
            "Your memories of the last Universe are fading and you have no idea how many times you've been here in this Universe. This could be your first or thousandth time here. Neat!",
        w30:
            "You're not sure how much more beautiful this one is than the last one, but it's hard not to stop and take in all the scenery every once in a while. Sprawling hills and flowing rivers in every direction make it almost worth the frankly ridiculous amount of enemies hiding everywhere.",
        w31: 'You deserve hazard pay or something.',
        w32:
            "One of your regular Trimps seems to have picked up the ability to speak a few words from Scruffy. They're too dirty to repeat though.",
        w34:
            "As you reach the top of another in this seemingly infinite sea of hills, you notice a tiny tablet. It's written in some language you've never seen, so you figure you'll hold on to it and see if Scruffy can translate.",
        w35:
            "Scruffy seems to be avoiding you ever since you found the tablet. You're not like... 100% positive but you're pretty sure.",
        w36:
            "You finally catch Scruffy while he's eating and ask him about the tablet. He tells you it's not a big deal, but that him and his six friends were all given some \"enhancements\" by Druopitee 500 years ago. Together they helped carry out Druopitee's bidding, setting up seven different Spires, harvesting Radon, and beaming the Power away. Scruffy lets you know that Fluffy and himself eventually realized how much damage Druopitee was causing to their planet and rebelled against Druopitee and the other Five. This tablet was an order from Druopitee to apprehend them.",
        w37:
            'You just realized... you thought you named Fluffy Fluffy. That sneaky telepathic Trimp!',
        w38:
            "You haven't seen Scruffy around the town much since your last conversation. Telling stories about his old friends seems to be painful for him, though you'd expect him to have moved through the grief stages after 500 years.",
        w39:
            "You ask Scruffy why he's so conversational and Fluffy is not. Scruffy shows you a whole trove of books that Druopitee had left behind, that Scruffy had been reading for the past 500 years. You figure Fluffy spent most of that 500 years stuck in a time loop.",
        w40: 'A Trimp eats a rock.',
        w42:
            "You wonder how Fluffy ended up in your Universe if he started out here. You'll ask Scruffy about it when he quits being all sulky.",
        w45:
            'Today, you held the first annual Trimp Toss. It was a pretty nice day.',
        w50: 'This zone is really freaking hot.',
        w52:
            'You catch Scruffy helping a group of small Trimps across a river. What a cool dude.',
        w57:
            'A few of your Trimps are getting whiny so you take them for a walk. Seemed to do the trick, they just needed to burn some energy and pee.',
        w60:
        ...
        w61:
            'Scruffy finally seems more inspired than sad. Looks like he wants to go take down some bad guys.',
        w62:
            "It seems like you've gotta take down the Five Evil Trimps. Scruffy reminds you that you're still about 140 Zones away from the first one though. You try to find something else to direct anger at, like that tree over there.",
        w65:
            'You wonder if Trimps came from this Universe, your original one, or somewhere else. Scruffy shrugs.',
        w67:
            'The weather is finally starting to cool back down, you and your Trimps are quite relieved.',
        get w69() {
        ...
        w72:
            "You really don't like Druopitee. You've spent an unknown amount of lifetimes cleaning up his mess, and who knows how many different Universes he's corrupted.",
        w75: 'You miss Fluffy, you should go visit him soon.',
        w79:
            "You're a little bit closer to the first Spire. Coming for you, Huffy.",
        w82:
            "You thought you saw Druopitee but it was just a tree. On closer inspection it doesn't even look anything close to him.",
        w85: 'This zone feels needy, like it wants your help with something.',
        w90:
            "As you near the halfway point to the first Spire, Scruffy sits you down for another story. Excited to hear more about Fluffy and Scruffy's history together, you listen intently. Scruffy just rambles about gems and how we could be rich selling jewelry then starts dancing. Seems like Scruffy's been fermenting berries again.",
        w93:
            "Scruffy created some sort of instrument out of a Snimp and some wood that he calls the Riflunger. It makes better music than you expected, but you wouldn't buy any albums.",
        w95:
            "Scruffy lets you know that Fluffy was the first modified Trimp created by Druopitee, and was always Druopitee's favorite. Druopitee was probably extra pissed when Fluffy was the one who rebelled and destroyed a couple Spires, that's probably why he was caged when you found him.",
        w100:
            'Halfway there. The lands ahead are bare and undeveloped, but you appear to be pressing on anyways.',
    };
...
function setGoldenBonusAchievementText() {
    ...
    if (tier < tiers.length)
        ...
        if (bonus <= 10000)
            ...
            html +=
                ' Start with 1 extra Golden Upgrade after each Portal for every 2000% earned above ' +
                prettify(10000);
        html +=
            '%. Currently gaining ' +
            count +
...
function toggleAchievementHelp() {
    document.getElementById(
        'achievementHelp',
    ).style.color = trimpAchievementHelpOn ? '#202080' : '#6060C0';
    document.getElementById(
        'achievementHeader',
    ).style.display = trimpAchievementHelpOn ? 'block' : 'none';
    document.getElementById(
        'achievementHelpContainer',
    ).style.display = trimpAchievementHelpOn ? 'none' : 'block';
...
function screenReaderSummary() {
    ...
    var srSumMapNameContainer = document.getElementById(
        'srSumMapNameContainer',
    );
    var srSumMapCellContainer = document.getElementById(
